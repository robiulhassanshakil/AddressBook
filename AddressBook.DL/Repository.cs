...
namespace AddressBook.DL
{
    ...
    where TContext : DbContext
    {
        ...
        public virtual async Task<IList<TEntity>> GetAllAsync() => await _dbSet.ToListAsync();
          ...
          IDictionary<string, Type> outParameters = null)
        {
            ...
            var flag = false;
            if (dbNull.Connection != null && dbNull.Connection.State == ConnectionState.Closed)
            {
